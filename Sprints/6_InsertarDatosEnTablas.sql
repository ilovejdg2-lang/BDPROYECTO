/* ============================================================================
   ...
   codigo_interno_asignatura: 1-9 historicas 2024 | 10-28 vigentes 2025
   Sedes: Liberia (Redes + Software) | Nicoya (Contabilidad + Diseno + Administracion)
   ============================================================================ */
...
-- AULAS (Liberia: Redes y Software | Nicoya: Contabilidad, Diseno y Administracion)
USE InstitutoTECNIC;
GO
...
-- ASIGNATURAS HISTORICAS 2024 (codigo_interno 1-9, las mas antiguas)
USE InstitutoTECNIC;
GO
...
-- ASIGNATURAS VIGENTES 2025 (codigo_interno 10-28)
USE InstitutoTECNIC;
GO
EXEC sp_Asignatura_Insertar @codigo_oficial = 'RED-101', @nombre_asignatura = 'Fundamentos de Redes', @duracion_horas_asignatura = 80, @codigo_interno_profesor = 2, @id_aula = 1, @id_periodo = 3, @antiguedad_profesor = 4, @fecha_inicio_imparticion_profe = '2025-02-01';
...
EXEC sp_Asignatura_Insertar @codigo_oficial = 'CON-101', @nombre_asignatura = 'Contabilidad Básica', @duracion_horas_asignatura = 90, @codigo_interno_profesor = 4, @id_aula = 5, @id_periodo = 3, @antiguedad_profesor = 4, @fecha_inicio_imparticion_profe = '2025-02-01';
...
-- HORARIO (28 franjas: una por asignatura)
USE InstitutoTECNIC;
GO
...
-- HORARIO-ASIGNATURA (las 28 ofertas tienen horario)
USE InstitutoTECNIC;
GO
-- Vigentes 2025 (10-28)
...
-- ASIGNATURA-PRERREQUISITO (solo ofertas vigentes 2025)
USE InstitutoTECNIC;
GO
...
-- ASIGNATURA-MATRICULA 2024 (ofertas historicas 1-9)
USE InstitutoTECNIC;
GO
...
EXEC sp_AsignaturaMatricula_Insertar @codigo_interno_asignatura = 23, @id_matricula = 8;
...
EXEC sp_NotaFinal_Insertar @estado_nota = 'En curso', @id_estudiante = 2, @codigo_interno_asignatura = 23;
...
EXEC sp_Asistencia_Insertar @fecha_asistencia = '2025-03-05 14:00', @estado_asistencia = 'Presente', @id_estudiante = 2, @codigo_interno_asignatura = 23;
...
-- TUTORIA (un tutor distinto por curso, sin repetir)
USE InstitutoTECNIC;
GO
EXEC sp_Tutoria_Insertar @codigo_interno_profesor = 2, @id_curso = 1, @antiguedad_tutor = 2, @fecha_inicio_tutoria = '2023-02-01';
EXEC sp_Tutoria_Insertar @codigo_interno_profesor = 6, @id_curso = 2, @antiguedad_tutor = 3, @fecha_inicio_tutoria = '2024-02-01';
EXEC sp_Tutoria_Insertar @codigo_interno_profesor = 4, @id_curso = 3, @antiguedad_tutor = 4, @fecha_inicio_tutoria = '2021-02-01';
EXEC sp_Tutoria_Insertar @codigo_interno_profesor = 7, @id_curso = 4, @antiguedad_tutor = 5, @fecha_inicio_tutoria = '2022-02-01';
EXEC sp_Tutoria_Insertar @codigo_interno_profesor = 8, @id_curso = 5, @antiguedad_tutor = 2, @fecha_inicio_tutoria = '2023-02-01';
EXEC sp_Tutoria_Insertar @codigo_interno_profesor = 9, @id_curso = 6, @antiguedad_tutor = 3, @fecha_inicio_tutoria = '2024-02-01';
EXEC sp_Tutoria_Insertar @codigo_interno_profesor = 1, @id_curso = 7, @antiguedad_tutor = 3, @fecha_inicio_tutoria = '2022-02-01';
EXEC sp_Tutoria_Insertar @codigo_interno_profesor = 3, @id_curso = 8, @antiguedad_tutor = 4, @fecha_inicio_tutoria = '2023-02-01';
